...
def encode(lonlat, length=12):
    ...
    lon = _float_to_bits(lonlat[0], lower=-180.0, upper=180.0, length=PRECISE_LENGTH[length]['lng'])
    lat = _float_to_bits(lonlat[1], lower=-90.0, upper=90.0, length=PRECISE_LENGTH[length]['lat'])
